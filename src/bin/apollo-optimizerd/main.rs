...
use apollo_optimizer::engine::llm::{
    append_jsonl, feedback_path_root, load_repo_config, policy_path_root,
...
use apollo_optimizer::engine::types::{
    ...
    InteractiveContext, LatencyTarget,
...
// is_peer_root, handle_client, broadcast_current_status, process_request,
// build_llm_status, run_socket_server → socket_handler

// handle_client through build_llm_status → socket_handler module



// llm_reactive_tick, windowserver_cpu, usage_learning_tick, apply_learned_policy_actions → llm_daemon

// run_socket_server → socket_handler
