...
pub struct PlanReport {
    ...
    pub counterfactual_ranked: u64,
    pub episodic_ranked: u64,
    ...
    pub temporal_authoritative_rollouts: u64,
    pub temporal_authoritative_expected_gain: f64,
    pub temporal_authoritative_uncertainty: f64,
    pub temporal_authoritative_pressure_delta: f64,
    pub temporal_authoritative_fluidity_delta: f64,
    pub temporal_authoritative_energy_delta: f64,
